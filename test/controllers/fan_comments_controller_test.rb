...
class FanCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fan_comment" do
    assert_difference('FanComment.count') do
      post fan_comments_url, params: { fan_comment: { body: @fan_comment.body, deleted: @fan_comment.deleted, name: @fan_comment.name, suthor_no: @fan_comment.suthor_no } }
    end
  ...
  test "should update fan_comment" do
    patch fan_comment_url(@fan_comment), params: { fan_comment: { body: @fan_comment.body, deleted: @fan_comment.deleted, name: @fan_comment.name, suthor_no: @fan_comment.suthor_no } }
